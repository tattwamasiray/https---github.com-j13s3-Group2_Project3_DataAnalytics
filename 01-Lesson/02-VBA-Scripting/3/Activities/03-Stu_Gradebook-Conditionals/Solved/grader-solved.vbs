Sub GradeBook()
  ...
  ' Check if the student's grade is greater than or equal to 85...
  If Cells(2, 2).Value >= 85 Then

      ' Establish that the grade is Passing
      Cells(2, 3).Value = "Pass"

      ' Colour the Passing grade green
  ...
  ' Check if the student's grade is greater than or equal to 50...
  ElseIf Cells(2, 2).Value >= 50 Then

      ' Establish that the grade is a Warning
      Cells(2, 3).Value = "Warning"

      ' Colour the Warning grade yellow
