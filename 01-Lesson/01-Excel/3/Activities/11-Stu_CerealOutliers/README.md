...
* Open up the activity workbook [Unsolved/Outliers_Activity_Unsolved.xlsx](Unsolved/Outliers_Activity_Unsolved.xlsx), and familiarise yourself with the raw data.
